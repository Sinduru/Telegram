...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    username = update.effective_user.username or "anonym"  # Fallback om användaren inte har ett användarnamn
    ...
    if len(user_images[user_id]["images"]) >= 3:
        ...
        user_info_message = f"Användare: @{username} (ID: {user_id}) har skickat följande bilder:\n"
